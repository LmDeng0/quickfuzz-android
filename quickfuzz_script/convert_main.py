...
if __name__ == "__main__":
    cvr = Converter("/root/quickfuzz-liming2/huawei/bss_func.txt", "/root/quickfuzz-liming2/huawei/libaudioprocessing_pcb.s")
    cvr.gen_format_result()
    cvr.section_rebuild()
    cvr.dump_result("/root/quickfuzz-liming2/huawei/libaudioprocessing_pcb_bss.s")
