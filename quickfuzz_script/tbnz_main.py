...
class TbnzHanler:
    ...
    def __init__(self, err_file, source_file):
        ...
        self.save_path = "/root/quickfuzz-liming2/huawei/libaudioprocessing_test_asan_bss_got_tbnz.s"
...
if __name__ == "__main__":
    th = TbnzHanler("error.txt", "/root/quickfuzz-liming2/huawei/libaudioprocessing_test_asan_bss_got.s")
    th.info_format()
